...
if(isset($_POST["upload"]))
{
 if($_FILES['product_file']['name'])
 {
    ...
    while($data = fgetcsv($handle))
    {
      ...
      $sql="SELECT * FROM `total_population` where `Year`='$Year' limit 1";
        $result = mysqli_query($connect,$sql);
        if(mysqli_num_rows($result)==1){
          header("location: total_population.php?fail=1");
        }else{
          $query = "
      ...
      mysqli_query($connect, $query); 
          header("location: total_population.php?updation=1");
        }
   ...
   <div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="action/delete_total_population.php" method="POST">
